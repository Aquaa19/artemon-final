...
// Using your custom domain for public assets and links
...
// Helper for Branded Email Styles with Logo Support
...
          <img src="${LOGO_URL}" alt="Artemon Joy" style="height: 64px; width: 64px; border-radius: 50%; border: 3px solid #ffffff; margin-bottom: 12px; object-fit: cover;">
          <h1 style="color: #ffffff; margin: 0; font-size: 24px; font-weight: 800; letter-spacing: -0.025em; display: block;">Artemon Joy</h1>
        </a>
      </div>
...
        <a href="${BASE_URL}/shop" style="background-color: #4f46e5; color: #ffffff; padding: 16px 32px; border-radius: 12px; font-weight: 700; text-decoration: none; display: inline-block;">
          Start Shopping Now
        </a>
      </div>
    `),
...
        <a href="${BASE_URL}/profile" style="background-color: #4f46e5; color: #ffffff; padding: 16px 32px; border-radius: 12px; font-weight: 700; text-decoration: none; display: inline-block; box-shadow: 0 4px 10px rgba(79, 70, 229, 0.3);">
          Track Your Order
        </a>
      </div>
