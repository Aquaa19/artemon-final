...
import Newsletter from './Newsletter'; // Importing your functional newsletter component

export default function Footer() {
  return (
    <div className="relative mt-20">
      
      {/* Decorative Wave Top - Playful transition */}
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                {[Facebook, Instagram, Twitter].map((Icon, i) => (
                  <a key={i} href="#" className="p-2.5 bg-indigo-900/50 rounded-full hover:bg-indigo-600 hover:text-white text-indigo-300 transition-all hover:-translate-y-1">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <div className="mt-1 p-1.5 bg-indigo-900/50 rounded-lg text-indigo-400">
                ...
                <li className="flex items-center gap-3">
                  <div className="p-1.5 bg-indigo-900/50 rounded-lg text-indigo-400">
